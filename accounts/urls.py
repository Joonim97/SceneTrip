...
from . import views
from .views import (SignupAPIView, VerifyEmailAPIView, LogoutAPIView, SubscribeView, Mypage, LoginView,
                    PasswordResetRequestView, PasswordResetConfirmView, EmailResetRequestView,
                    EmailResetConfirmView, MyJournalsListAPIView, SavedLocationsListAPIView, 
                    LikeJournalsListAPIView, SubscribingsListAPIView, SubsribingsjournalAPI, 
                    MyCommunityListAPIView, DeleteAPIView, VerifyjJournalEmailAPIView, UserInfoView)
